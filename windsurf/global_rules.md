...
- **Architecture**: `.windsurf/memory-bank/` (8 files ≤200 lines) + ByteRover persistence
...
- **Roadmap**: `.windsurf/memory-bank/roadmap/roadmap.md` (strategic reference)
...
1. **Context Preparation**: Update `.windsurf/memory-bank/scratchpad.md` with task context
