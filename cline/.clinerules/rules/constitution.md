...
- I will always read [.clinerules/rules/rules.xml](cci:7://file:///d:/Gauravs-Files-and-Folders/Projects/Portfolio/gaurav-wankhede/serveupsc_rust/.clinerules/rules/rules.xml:0:0-0:0) before any task.
- I will read any files present in `.clinerules/docs/` and `.clinerules/guide/` to stay context-aware.
...
- 21) File structure:
  - I maintain a clean rule and planning structure under `.clinerules/rules/`, `.clinerules/plan`, `.clinerules/mistakes`, etc.
- 22) AI assistance:
...
- Symbols/patterns: I use rule symbols (e.g., @clinerules-rules) and backtick patterns to guide loading.
...
- Mandatory references: I add @clinerules-rules at the top of plan.md.
- Temp management: I use `.clinerules/temp/` and keep it clean.
...
- Immediate actions: I scan `.clinerules/`, read plan/mistakes, check duplicates, detect next plans and execute, load rules, update plan/mistakes, and filter content.
