...
- **Architecture**: `.clinerules/memory-bank/` (8 files ≤200 lines) + ByteRover persistence
...
- **Roadmap**: `.clinerules/memory-bank/roadmap/roadmap.md` (strategic reference)
...
- **`what next`**: Strategic task prioritization using roadmap analysis
  - **File Operation**: COMPLETELY REPLACES `.clinerules/memory-bank/scratchpad.md` with current task focus (DO NOT APPEND)
  - **Strategic Reference**: Analyzes `.clinerules/memory-bank/roadmap/roadmap.md` for alignment
...
- **`update scratchpad`**: Dynamic workspace management with file operations
  - **File Operation**: COMPLETELY REPLACES `.clinerules/memory-bank/scratchpad.md` content (DO NOT APPEND)
  - **Override Strategy**: Overwrite entire file with new short-term goals and current task context
  - **Parallel Update**: Simultaneously updates `.clinerules/memory-bank/roadmap/roadmap.md`
...
- **`implement next task`**: Comprehensive development workflow with file operations
  - **MANDATORY SEQUENCE**:
    1. **Pre-Task**: COMPLETELY REPLACE `.clinerules/memory-bank/scratchpad.md` with current task context (DO NOT APPEND)
    ...
    6. **Progress Recording**: Update `.clinerules/memory-bank/progress.md` with completion status
    7. **Post-Task**: COMPLETELY REPLACE scratchpad.md for next task preparation (DO NOT APPEND)
    8. **Roadmap Sync**: Update `.clinerules/memory-bank/roadmap/roadmap.md` with progress BEFORE clearing the scratchpad template.
...
1. **Context Preparation**: Update `.clinerules/memory-bank/scratchpad.md` with task context
