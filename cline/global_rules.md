...
- "sync docs to memory bank" — review `.clinerules/docs/` and `.clinerules/guide/index.md` folders and update Memory Bank files with relevant information [github + context7]
- "update docs and guide" — review and update documentation in `.clinerules/docs/` and `.clinerules/guide/` folders [github + context7]
