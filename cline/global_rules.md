...
This Memory Bank operates as the Executive under the Constitution defined in `.clinerules/rules/constitution.md`.
...
- Always-On Rule Awareness (Cline-specific):
  - Always read `.clinerules/rules/constitution.md` before any task for best awareness.
...
| "sync docs to memory bank" | Review `.clinerules/docs/` and `.clinerules/guide/index.md` and update Memory Bank accordingly | github + context7 |
| "update docs and guide" | Review and update documentation in `.clinerules/docs/` and `.clinerules/guide/` | github + context7 |
