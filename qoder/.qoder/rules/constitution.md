...
- I will always read [.qoder/rules/rules.xml](cci:7://file:///d:/Gauravs-Files-and-Folders/Projects/Portfolio/gaurav-wankhede/serveupsc_rust/.qoder/rules/rules.xml:0:0-0:0) before any task.
- I will read any files present in `.qoder/docs/` and `.qoder/guide/` to stay context-aware.
...
- 21) File structure:
  - I maintain a clean rule and planning structure under `.qoder/rules/`, `.qoder/plan`, `.qoder/mistakes`, etc.
- 22) AI assistance:
...
- Symbols/patterns: I use rule symbols (e.g., @qoder-rules) and backtick patterns to guide loading.
...
- Mandatory references: I add @qoder-rules at the top of plan.md.
- Temp management: I use `.qoder/temp/` and keep it clean.
...
- Immediate actions: I scan `.qoder/`, read plan/mistakes, check duplicates, detect next plans and execute, load rules, update plan/mistakes, and filter content.
