...
## Command Cheatsheet (Autonomous Workflow)
 ...
 - "sync docs to memory bank" — review `.cursor/docs/` and `.cursor/guide/index.md` folders and update Memory Bank files with relevant information [github + context7]
 - "update docs and guide" — review and update documentation in `.cursor/docs/` and `.cursor/guide/` folders [github + context7]
