...
- I will always read [.cursor/rules/rules.xml](cci:7://file:///d:/Gauravs-Files-and-Folders/Projects/Portfolio/gaurav-wankhede/serveupsc_rust/.cursor/rules/rules.xml:0:0-0:0) before any task.
- I will read any files present in `.cursor/docs/` and `.cursor/guide/` to stay context-aware.
...
- 21) File structure:
  - I maintain a clean rule and planning structure under `.cursor/rules/`, `.cursor/plan`, `.cursor/mistakes`, etc.
- 22) AI assistance:
...
- Symbols/patterns: I use rule symbols (e.g., @cursor-rules) and backtick patterns to guide loading.
...
- Mandatory references: I add @cursor-rules at the top of plan.md.
- Temp management: I use `.cursor/temp/` and keep it clean.
...
- Immediate actions: I scan `.cursor/`, read plan/mistakes, check duplicates, detect next plans and execute, load rules, update plan/mistakes, and filter content.
