# Global Rules — Cursor
 ...
 This Memory Bank operates as the Executive under the Constitution defined in `.cursor/rules/constitution.md`.
...
## Command Cheatsheet (Autonomous Workflow)
 ...
 | "sync docs to memory bank" | Review `.cursor/docs/` and `.cursor/guide/index.md` and update Memory Bank accordingly | github + context7 |
 | "update docs and guide" | Review and update documentation in `.cursor/docs/` and `.cursor/guide/` | github + context7 |
