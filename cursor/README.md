# AegisIDE — Cursor Constitutional Framework (2025 Enhanced)
 
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](../LICENSE.md) [![Docs](https://img.shields.io/badge/docs-read-blue)](./guide/index.md) [![Autonomy](https://img.shields.io/badge/Autonomy-96%25-success)](global_rules.md)
...
**Cursor Constitutional Framework** with **democratic parliamentary governance**, **96% autonomous capability**, **always-check operations**, and **centralized configuration validation**.
...
> 📜 **Complete Command Reference**: See [CheatSheet.md](CheatSheet.md) for all constitutional commands with detailed usage instructions.

## 🔧 **Cursor Setup Instructions**

### **Quick Setup Process**

#### **Step 1: Copy Constitutional Framework to Project**
```bash
# Navigate to your project root
cd /path/to/your/project

# Copy the complete .cursor constitutional structure
cp -r /path/to/AegisIDE/cursor/.cursor ./
...
#### **Step 2: Initialize Constitutional AI**
```bash
# In Cursor chat, initialize the constitutional framework
...
#### **Step 3: Begin Constitutional Development**
- Framework is now active with **96% autonomy**
- All constitutional commands available in Cursor chat
...
- **Built-in AI Integration**: Native AI assistant works seamlessly with constitutional framework
- **Config Registry Support**: Real-time validation with centralized configuration management
- **Universal IDE Support**: Compatible with VS Code extensions and workflows
- **Always-Check Operations**: Automatic pre-task validation for 8+ languages
- **Constitutional Compliance**: Real-time monitoring with parliamentary oversight
...
1. **Load Constitutional Framework** (copy `.cursor/` structure)
...
## ⚡ **Always-Check Operations & Quality Framework**
...
- **Framework Auto-Detection**: Smart detection from package.json, Cargo.toml, etc.
...
- **Official Sources**: Include URLs in `guide/index.md` for constitutional compliance
- **Library Integration**: Prefer Context7 library IDs (e.g., `/vercel/next.js`) for up-to-date docs
- **Real-Time Validation**: Constitutional compliance with documentation accuracy

## 🚀 **Constitutional Framework Summary**

### **What You Get with AegisIDE + Cursor**
- **96% Autonomous AI Development** with democratic parliamentary governance
...
- **Built-in AI Integration** works seamlessly with Cursor's native AI assistant

### **🏆 Quick Start**
1. **Copy `.cursor/` structure** → Your project root (framework integration)
2. **Initialize with context** → `initialize memory bank` + project details
3. **Begin autonomous development** → Constitutional AI ready!

### **📚 Reference Documentation**
- **[CheatSheet.md](CheatSheet.md)**: Complete command reference (constitutional commands)
- **[global_rules.md](global_rules.md)**: Executive implementation rules (96% autonomous operation)
- **[Universal Constitution](../windsurf/.windsurf/rules/constitution.md)**: Supreme constitutional law (12 articles)

**🎆 Constitutional AI Development Active** - Experience 96% autonomous capability with democratic governance, real-time quality assurance, and intelligent decision-making!
...
- **[Windsurf Setup](../windsurf/README.md)**: Maximum autonomy IDE setup (99%)
- **[Universal Constitution](../common/universal_constitution.md)**: IDE-agnostic constitutional framework

### **Cursor-Specific Files**
- **[Memory Bank Templates](.cursor/memory-bank/templates/)**: Auto-generation templates
- **[Project Documentation](.cursor/docs/)**: Cursor-specific implementation guides
- **[Constitutional Rules](.cursor/rules/)**: Cursor constitutional framework
...
**Constitutional Compliance Active** | **Democratic Governance Enabled** | **96% Autonomous Operation** ✅
