...
> The Ultimate Constitutional Workflow for All AI Coding Assistants (2025 Enhanced)
 [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE.md) [![Docs](https://img.shields.io/badge/docs-read-blue)](docs/) [![AI IDEs](https://img.shields.io/badge/AI%20IDEs-8+-brightgreen)](common/) [![Autonomy](https://img.shields.io/badge/Autonomy-95%25-success)](common/universal_constitution.md)
...
```mermaid
flowchart TD
    Start[Task Initiated] --> Constitutional[Auto-scan Constitution]
    Constitutional --> Memory[Load Memory Bank]
    Memory --> Impact[Calculate Impact Score]
    Impact --> Authority{Decision Authority Level}
    
    Authority -->|0-30| Auto[Execute Autonomously]
    Authority -->|31-60| Doc[Document & Execute]  
    Authority -->|61-80| Val[Validate & Execute]
    Authority -->|81-100| Human[Human Consultation]
    
    Auto --> Execute[Real-time Execution]
    Doc --> Execute
    Val --> Execute
    Human --> Execute
    
    Execute --> Monitor[Constitutional Monitoring]
    Monitor --> Quality[Quality Gates Check]
    Quality --> Update[Update Memory Bank]
    Update --> Learn[Pattern Learning]
    Learn --> Complete[Task Complete]
```
